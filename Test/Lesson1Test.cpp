...
class Lesson1Test
{
  ...
  private:
    Lesson1Test(const Lesson1Test&) = delete;    // Copy Constructor Not Implemented
    void operator=(const Lesson1Test&) = delete; // Operator '=' Not Implemented
};
