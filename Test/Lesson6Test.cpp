...
class Lesson6Test
{
  ...
  private:
    Lesson6Test(const Lesson6Test&) = delete;    // Copy Constructor Not Implemented
    void operator=(const Lesson6Test&) = delete; // Operator '=' Not Implemented
};
